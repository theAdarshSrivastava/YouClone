...
In addition to viewing the videos, users can also check the current number of subscriber as well as the number of likes and comments on a particular video.
